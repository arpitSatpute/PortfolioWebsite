...
export default function Portfolio() {
  ...
  const roles = ["Blockchain Developer", "Full Stack Developer", "Software Developer"];
      ...
      <div className="bg-white dark:bg-zinc-950 text-zinc-900 dark:text-zinc-100 antialiased font-body min-h-screen transition-colors duration-300">
          ...
          <nav className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
            ...
            <ul className="hidden md:flex items-center gap-8 text-sm">
              {[
                ...
                <li key={item.id}>
                  <button onClick={() => scrollToSection(item.id)} className={`nl text-zinc-500 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-white transition-colors capitalize ${activeSection === item.id ? 'on !text-zinc-900 dark:!text-white' : ''}`}>
                    {item.label}
                  </button>
                </li>
              ))}
            ...
            <div className="md:hidden bg-white dark:bg-zinc-950 border-t border-zinc-100 dark:border-zinc-900 shadow-xl absolute top-16 left-0 w-full">
              <ul className="flex flex-col px-6 py-5 gap-4 text-sm font-medium">
                {[
                  ...
                  <li key={item.id}>
                    <button onClick={() => scrollToSection(item.id)} className="block text-zinc-700 dark:text-zinc-300 hover:text-[#FF6B2B] transition-colors capitalize text-left">
                      {item.label}
                    </button>
                  </li>
                ))}
            ...
            <div className="relative z-10 max-w-6xl mx-auto px-6 py-24 w-full">
              <div className="grid md:grid-cols-2 gap-12 items-center">
                ...
                <div className="flex flex-col items-center gap-6">
                  ...
                  {/* Job role alternating display */}
                  <div className="mt-2 flex justify-center w-full">
                    <div className="relative h-8 overflow-hidden w-64 md:w-72 lg:w-80">
                      <div
                        key={currentRoleIndex}
                        className="absolute inset-0 text-zinc-950 dark:text-zinc-50 font-body font-bold text-lg md:text-xl lg:text-2xl tracking-tight animate-fade-slide flex items-center justify-center"
                      >
              ...
              <div className="grid md:grid-cols-2 gap-16 items-start">
                <div className="order-1">
                  ...
                  <div className="flex flex-col gap-4">
                    ...
                    <a href={profile.github} target="_blank" rel="noopener noreferrer" className="group flex items-center gap-3 text-zinc-500 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-white transition-colors">
                      <span className="w-10 h-10 flex items-center justify-center bg-zinc-200 dark:bg-zinc-800 rounded-lg group-hover:bg-[#FF6B2B]/20 transition-colors shrink-0">
                        <Github size={18} />
                      </span>
                      <span className="text-sm font-medium">Follow on GitHub</span>
                    </a>
                    <a href={profile.twitter} target="_blank" rel="noopener noreferrer" className="group flex items-center gap-3 text-zinc-500 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-white transition-colors">
                      <span className="w-10 h-10 flex items-center justify-center bg-zinc-200 dark:bg-zinc-800 rounded-lg group-hover:bg-[#FF6B2B]/20 transition-colors shrink-0">
                        <X size={18} />
                      </span>
                      <span className="text-sm font-medium">Follow on X (Twitter)</span>
                    </a>
                  </div>
                </div>
        ...
        {selectedProject && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 md:p-6">
            ...
            <div className="bg-[#1c1a19] w-full max-w-4xl max-h-[90vh] rounded-[40px] border border-white/10 relative animate-in fade-in zoom-in duration-300 shadow-2xl shadow-black overflow-y-auto custom-scrollbar scroll-smooth font-body">
              <div className="p-6 md:p-10 relative">
                <div className="sticky top-0 z-20 flex justify-between items-start mb-8 gap-4 bg-[#1c1a19]/90 backdrop-blur-md pb-4 pt-2 -mt-2">
                  <div className="flex-1">
                    <h3 className="font-display text-3xl md:text-4xl font-black uppercase tracking-tighter mb-4 leading-none text-white">{selectedProject.title}</h3>
                ...
                <div className="space-y-12">
                  ...
                  <div className="px-1 md:px-4">
                    <h4 className="font-display font-black text-[11px] tracking-[0.3em] uppercase text-[#FF4D00] mb-6">Live Preview</h4>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                    <div>
                      <h4 className="font-display font-black text-[11px] tracking-[0.3em] uppercase text-[#FF4D00] mb-6 px-1">Key Achievements</h4>
                    ...
                    <div className="space-y-8">
                      <div>
                        <h4 className="font-display font-black text-[11px] tracking-[0.3em] uppercase text-[#FF4D00] mb-6 px-1">Tech Stack</h4>
                        <div className="flex flex-wrap gap-2">
                          {selectedProject.tech.map((tech, i) => (
                            <span
                              key={i}
                              className="px-4 py-2 bg-white/5 border border-white/10 rounded-xl text-[10px] font-black tracking-widest text-white uppercase"
                            >
                              {tech}
                            </span>
                          ))}
